...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(orderUtils.deleteDuplicates(ordersList));

        /*System.out.println();
        System.out.println(ordersList);
        System.out.println(orderUtils.deleteUnderPrice1500(ordersList));*/

        orderUtils.separateCurrency(ordersList);
